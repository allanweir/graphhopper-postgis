 ...
 * @author Robin Boldt
 */
public class OSMPostgisReaderNew implements DataReader, TurnCostParser.ExternalInternalMap {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(OSMPostgisReaderNew.class);
    ...
    public OSMPostgisReaderNew(GraphHopperStorage ghStorage, Map<String, String> postgisParams) {
